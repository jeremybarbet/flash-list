...
class AutoLayoutShadow {
   ...
   * (Only Grid layouts with varying spans). Performance: RecyclerListView renders
   * very small number of views and this is not going to trigger multiple layouts
   * on Android side. Not expecting any major perf issue.
   */
  ...
  /**
   * Offset provided by react can be one frame behind the real one, it's important that this
   * method is called with offset taken directly from scrollview object
   */
