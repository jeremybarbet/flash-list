...
/**
 * ViewManager for AutoLayoutView - Container for all RecyclerListView children.
 * Automatically removes all gaps and overlaps for GridLayouts with flexible spans.
...
class AutoLayoutViewManager : ViewGroupManager<AutoLayoutView>(),
  ...
  override fun setMaintainVisibleContentPosition(
    view: AutoLayoutView,
    isMaintaining: Boolean
  ) {
    view.maintainVisibleContentPosition = isMaintaining
  }
