...
public class BidirectionalScrollView extends ReactScrollView {
  ...
  private OverScroller getOverScrollerFromParent() {
    ...
    try {
      ...
      FLog.w("ScrollView", "Failed to get mScroller field for ScrollView! This app will exhibit the bounce-back scrolling bug");
    }
