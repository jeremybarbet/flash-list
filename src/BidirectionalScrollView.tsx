...
import { BidirectionalNativeScrollView } from "./BidirectionalNativeScrollView";
import { processDecelerationRate } from "./native/config/PlatformHelper";
...
export class ScrollViewComponent extends ScrollViewRNRaw {
  ...
  render() {
    ...
    const props = {
      ...
      style: StyleSheet.compose(styles.baseVertical, this.props.style),
...
export const BidirectionalScrollView: ScrollViewType = forwardRef<
  ScrollViewType,
  ScrollViewProps
>((props, ref) => <ScrollViewComponent {...props} ref={ref} />);
